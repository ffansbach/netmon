...
$smarty->assign('permitted', UserManagement::checkIfUserIsOwnerOrPermitted(64, $_GET['user_id']));
$smarty->assign('show_routersnotassigned_list', ($_GET['user_id']==$_SESSION['user_id'] AND empty($routerlist)));
$smarty->assign('is_logged_in', Usermanagement::isLoggedIn($_SESSION['user_id']));
...
$smarty->assign('servicelist', Service::getServiceList(Usermanagement::isLoggedIn($_SESSION['user_id']) ? 'all' : 'public', $_GET['user_id']));
