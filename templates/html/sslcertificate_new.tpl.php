...
<form action="./index.php?get=vpn&section=generate&service_id={$data.service_id}" method="POST">
  ...
  <p>Common Name (Node-ID, muss eindeutig sein zwecks IP-Zuweisung!):<br><input name="commonname" type="text" size="30" maxlength="30"  value="{$data.service_id}"></p>
