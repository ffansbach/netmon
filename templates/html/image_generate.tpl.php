...
<h2>Download</h2>
<a href="./tmp/{$imagepath}/openwrt-atheros-root.squashfs" >openwrt-atheros-root.squashfs</a><br>
<a href="./tmp/{$imagepath}/openwrt-atheros-vmlinux.lzma" >openwrt-atheros-vmlinux.lzma</a>
