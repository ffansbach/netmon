<form action="./login.php?section=login_send" method="POST">
  ...
  <p><a href="./index.php?get=register&section=resend_password">Passort vergessen?</a> <a href="./index.php?get=register&section=resend_activation_mail">Aktivierungsmail erneut zusenden?</a></p>
