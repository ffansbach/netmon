...
{if !empty($last_ended_crawl_cycle)}
	...
	{foreach item=batman_advanced_version_count from=$batman_advanced_versions_count}
		<b>{$batman_advanced_version_count.batman_advanced_version}:</b> <a href="./routerlist.php?where=crawl_routers.batman_advanced_version&operator=%3D&value={$batman_advanced_version_count.batman_advanced_version}">{$batman_advanced_version_count.count}</a><br>
	{/foreach}
	</p>
	...
	{foreach item=kernel_version_count from=$kernel_versions_count}
		<b>{$kernel_version_count.kernel_version}:</b> <a href="./routerlist.php?where=crawl_routers.kernel_version&operator=%3D&value={$kernel_version_count.kernel_version}">{$kernel_version_count.count}</a><br>
	{/foreach}
	</p>
	...
	{foreach item=nodewatcher_version_count from=$nodewatcher_versions_count}
		<b>{$nodewatcher_version_count.nodewatcher_version}:</b> <a href="./routerlist.php?where=crawl_routers.nodewatcher_version&operator=%3D&value={$nodewatcher_version_count.nodewatcher_version}">{$nodewatcher_version_count.count}</a><br>
	{/foreach}
	</p>
