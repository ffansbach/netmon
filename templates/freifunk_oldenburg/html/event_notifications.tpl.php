		...
		<tbody>
			{foreach item=event_notification from=$event_notification_list}
				<tr>
					...
					<td>{if $event_notification->getNotificationDate()=='-62169987600'}Bisher keine versendet{else}{$event_notification->getNotificationDate()|date_format:"%d.%m.%Y %H:%M"} Uhr{/if}</td>
