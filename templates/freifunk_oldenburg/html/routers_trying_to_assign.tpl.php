			...
			<tbody>
				{foreach key=count item=router from=$routerlist}
					<tr>
						...
						<td><a href="./routereditor.php?section=new&hostname={$router.hostname}&crawl_method=netmon&allow_router_auto_assign=1&router_auto_assign_login_string={$router.router_auto_assign_login_string}">Übernehmen</a></td>
					</tr>
				{/foreach}
			</tbody>
		</table>
