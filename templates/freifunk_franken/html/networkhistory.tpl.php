...
<p>Historie der letzten <input name="history_hours" type="text" size="1" value="{if isset($smarty.post.history_hours)}{$smarty.post.history_hours}{else}5{/if}"> Stunden anzeigen <input type="submit" value="aktualisieren"></p>
</form>
...
{else}
<p>In den letzten 5 Stunden ist nichts passiert.</p>
{/if}