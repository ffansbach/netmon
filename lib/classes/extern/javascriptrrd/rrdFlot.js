...
//  cellRes.appendChild(document.createTextNode("Resolution:"));
  ...
  //Mychange
  cellDSTitle.style.display="none";
  //----
  ...
  elGraph.style.width="360px";
  elGraph.style.height="180px";
...
/*  var cellScaleLegend=rowScale.insertCell(-1);
  ...
  cellScale.appendChild(elScale);
    ...
    //Mychange
  var cellRes2=rowScale.insertCell(-1);
  cellRes2.appendChild(document.createTextNode("Resolution:"));
  var forRes2=document.createElement("Select");
  forRes2.id=this.res_id;
  //forRes.onChange= this.callback_res_changed;
  forRes2.onchange= function () {rf_this.callback_res_changed();};
  cellRes2.appendChild(forRes);
  //---------
...
//	  alert("positive_stack_list ds_name: "+ds_name);
	} else if (ds_stack_type=='negative') {
	  ds_negative_stack_list.push(ds_name);
//	  alert("negative_stack_list ds_name: "+ds_name);
	  
	} else {
	  ds_single_list.push(ds_name);
  //	  alert("ds_single_list ds_name: "+ds_name);
	}
	ds_colors[ds_name]=i;
      }
    }
    ...
    if (oCB.ds.checked==true) {
      ...
      ds_single_list.push(ds_name);
//    alert("single_element ds_single_list ds_name: "+ds_name);
      ds_colors[ds_name]=0;
    }
  }
...
/*  if (legend_id=="None") {
    ...
    graph_options.legend.show=true;
    graph_options.legend.position='ne';
